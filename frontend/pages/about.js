            ...
            <main className={styles.main}>
                ...
                <div className={styles.textContainer}>
                    <p>
                        ...
                        made out of pure boredom and built with <a target={"__blank"} href={"https://nextjs.org"}>Next.js</a>, <a target={"__blank"} href={"https://reactjs.org/"}>React</a>,
                        and <a target={"__blank"} href={"https://nodejs.org/"}>Node.js</a>. It is still being polished.
                        <br/>
                        <br/>
                        ...
                        <a target={"__blank"} href={"https://en.wikipedia.org/wiki/Advanced_Encryption_Standard"}> AES-256-CBC </a>
                        is used for encrypting the notes, and the encryption key is hashed with <a target={"__blank"} href={"https://en.wikipedia.org/wiki/PBKDF2"}>PBKDF2 </a>
                        ...
                        <br/>
                        <br/>
                        WackNotes is completely free, open-source software that can be found on <a target={"__blank"} href={"https://github.com/waves-rgb/notes"}>GitHub</a>.
                    </p>
                </div>
